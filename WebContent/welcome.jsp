    ...
    <nav id="tf-menu" class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="welcome.jsp">SketchnStipple</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>  <!-- <form action="LogoutServlet" method="post" > -->
                  <a href="LogoutServlet" class="page-scroll">Logout (<%=session.getAttribute("user")%>)</a>
                  <!-- </form> -->
            </li>
          </ul>
        </div><!-- /.navbar-collapse -->
    ...
    <div id="tf-contact" class="text-center">
        ...
        <div class="container"><br>
            <div class="pull-left fnav">
                <p>ALL RIGHTS RESERVED. COPYRIGHT © 2014. Designed by Abhishek Baj and Coded by Kshitiz, Lalit</p>
            </div>
